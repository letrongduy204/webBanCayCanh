...
<head>
  ...
  <style>
    ...
    .product-img-lg { width: 100%; height: 420px; object-fit: cover; border-radius: 16px; }
    ...
    .related-card:hover{ transform: translateY(-2px); box-shadow: 0 10px 22px rgba(0,0,0,.12); }
    .related-img{ height: 160px; width:100%; object-fit: cover; }
  </style>
</head>
  ...
  <div class="row g-4">
    ...
    <div class="col-12 col-lg-6">
      ...
      <div class="d-flex gap-2 mt-4">
        <button class="btn btn-success btn-lg w-100">Thêm vào giỏ</button>
        <button class="btn btn-outline-success btn-lg w-100">Mua ngay</button>
      </div>
    </div>
  </div>
    ...
    <div class="mt-5">
      ...
      <div class="row g-3">
        @foreach($related as $r)
          @php
            $rimg = $r->HinhAnhURL ? asset(ltrim($r->HinhAnhURL, '/')) : 'https://via.placeholder.com/600x450?text=Plant';
          @endphp
